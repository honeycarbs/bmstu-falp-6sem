\begin{titlepage}
	...
	\begin{center}
		...
		\Large\textbf{\textsc{по лабораторной работе №4}}\\
	\end{center}
	
	\vspace{1cm}
	
	\noindent\textnormal{Название:} \hspace{15mm} \underline{\textnormal{~~~~Использование управляющих структур, работа со списками~~~}}\noindent
